...
<body>
  <main>
    <nav class="d-flex justify-content-between px-5 py-4" id="navbar">
      <div class="logo">
              ...
              <div class="dropdown">
                ...
                <ul class="dropdown-menu p-0" aria-labelledby="dropdownMenuLink">
                  @foreach($item['dropdown'] as $dropdownItem)
                    <li><a class="dropdown-item py-2" href="{{ $dropdownItem['route'] }}">{{ $dropdownItem['name'] }}</a></li>
                  @endforeach
                </ul>
              </div>
            @else
              <a href="{{ $item['route'] }}" class="pe-auto text-decoration-none navigation">{{ $item['name'] }}</a>
            @endif
          @endforeach
    ...
    <footer class="bg-black text-white">
      <div class="footer row">
        <div id="carouselExampleSlidesOnly" class="carousel slide col d-flex align-items-end " data-bs-ride="carousel">
      ...
      <div class="footer row pb-5">
                      ...
                      @if (isset($menu['dropdown']))
                          <div class="accordion-item bg-transparent border-bottom">
                              <h2 class="accordion-header p-0">
                                  <button class="accordion-button collapsed bg-transparent text-white p-0 lh-lg fs-7" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse{{ $loop->index }}" aria-expanded="false" aria-controls="flush-collapse{{ $loop->index }}">
                                      {{ $menu['name'] }}
                                  </button>
                              </h2>
                              <div id="flush-collapse{{ $loop->index }}" class="accordion-collapse collapse" aria-labelledby="flush-heading{{ $loop->index }}" data-bs-parent="#accordionFlushExample">
                                  @foreach ($menu['dropdown'] as $dropdown)
                                      <a href="{{ $dropdown['route'] }}" class="accordion-body d-flex text-decoration-none text-white pilates">{{ $dropdown['name'] }}</a>
                                  @endforeach
                              </div>
                          </div>
                      @else
                          <div class="accordion-item bg-transparent border-bottom">
                              <h2 class="accordion-header p-0">
                                  <a href="{{ $menu['route'] }}" class="accordion-button text-decoration-none fw-normal collapsed bg-transparent text-white p-0 lh-lg fs-7">
                                      {{ $menu['name'] }}
                                  </a>
                              </h2>
                          </div>
          ...
          <div class="col text-end fs-8">
              ...
              <div class="d-flex flex-column">
                  <a href="https://maps.app.goo.gl/SBcNQFzbxBuyMTE8A"  class="email text-white" target="_blank">Jl. Poros Samarinda – Bontang, Kel. Sungai Siring, Samarinda – Kalimantan Timur 75119</a>
                  <a href="https://wa.me/62811551944" target="_blank" class="email text-white">+62 811 551 944</a>
                  <a href="mailto:mail.aptpranotoairport@gmail.com" target="_blank" class="email text-white">aptpranotoairport@gmail.com</a>
                  <div class="fs-4 d-flex gap-3 justify-content-end mt-5">
                      ...
                      <a href="https://www.facebook.com/aptpranotoairport/" target="_blank" class="text-white social-media">
                          <i class="bx bxl-facebook"></i>
                      </a>
                      <a href="https://www.twitter.com/aptp_airport" target="_blank" class="text-white social-media">
                          <i class="bx bxl-twitter"></i>
                      </a>
                      <a href="https://www.youtube.com/@aptpranotoairport" target="_blank" class="text-white social-media">
                          <i class="bx bxl-youtube"></i>
                      </a>
                      <a href="https://www.instagram.com/aptpranotoairport/" target="_blank" class="text-white social-media">
      ...
      <div class="footer text-start fs-9 mt-5 d-flex justify-content-between align-items-center" style="background-color: #0b0b0b;">
